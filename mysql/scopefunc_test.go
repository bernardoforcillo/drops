...
func operandConstructors(col drops.Expression) []operandCase {
	return []operandCase{
		...
		{"Count", mysql.Count},
		{"CountDistinct", mysql.CountDistinct},
		{"CountIf", mysql.CountIf},
