...
//
//	mysql.ApplyMixins(Users,
//	    mysql.UUIDPrimaryKeyMixin{},
//	    &mysql.TimestampsMixin{},  // adds timestamps + bumps updatedAt on UPDATE
//	    &mysql.SoftDeleteMixin{},  // adds deletedAt, default-scopes queries,
...
// IgnoreFilters(mysql.FilterSoftDelete), which leaves every other
